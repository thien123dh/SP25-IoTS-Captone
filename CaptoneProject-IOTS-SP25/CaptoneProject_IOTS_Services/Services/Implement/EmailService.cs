...
namespace CaptoneProject_IOTS_Service.Services.Implement
{
    public class EmailService : IEmailService
    {
        ...
        private string invoiceEmailTemplate = "<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'><title>Invoice</title><style>body { font-family: 'Arial', sans-serif; background: #f8f9fa; padding: 20px; display: flex; justify-content: center; align-items: center; min-height: 100vh; background-image: url('https://i.imgur.com/YOUR_IMAGE.jpg'); background-size: cover; background-position: center; } .invoice-container { width: 700px; background: white; padding: 20px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); border: 2px solid #555; position: relative; opacity: 0.95; } .logo-container { text-align: center; margin-bottom: 10px; } .logo-container img { width: 120px; display: block; margin: 0 auto; } .header, .invoice-date { text-align: center; } .divider { border-bottom: 1px solid #555; margin: 10px 0; } .info-box p { margin: 5px 0; font-size: 16px; } .table-container { width: 100%; border-collapse: collapse; margin-top: 10px; } .table-container th, .table-container td { border-bottom: 1px solid #ddd; padding: 10px; text-align: left; } .table-container th { background: white; font-size: 16px; font-weight: bold; } .table-container img { width: 50px; height: auto; display: block; } .total-row td { font-weight: bold; background: #f1f1f1; text-align: right; } .total-amount { text-align: right; font-size: 18px; font-weight: bold; margin-top: 10px; } .ghtk-logo-container { text-align: center; margin-top: 20px; } .ghtk-logo-container img { width: 100%; height: auto; opacity: 0.8; }</style></head><body><div class='invoice-container'><div class='logo-container'><img src='https://i.imgur.com/8IC5op2.jpeg' alt='Company Logo'></div><div class='header'>Invoice Information</div><div class='invoice-date'>Date: {DATE}</div><div class='divider'></div><div class='info-box'><p><strong>Invoice ID:</strong> {INVOICE_ID}</p></div><div class='divider'></div><div class='info-box'><p><strong>Sender:</strong> {SENDER_NAME}</p><p>{SENDER_ADDRESS}</p><p>Email: {SENDER_EMAIL}</p></div><div class='divider'></div><div class='info-box'><p><strong>Recipient:</strong> {RECEIVER_NAME}</p><p>{RECEIVER_PROVINCE}, {RECEIVER_DISTRICT}, {RECEIVER_WARD}, {RECEIVER_ADDRESS}</p></div><div class='divider'></div><table class='table-container'><thead><tr><th>Image</th><th>Product</th><th>Quantity</th><th>Unit Price</th><th>Total</th></tr></thead><tbody>{PRODUCT_ROWS}<tr class='total-row'><td colspan='4'>Total Product Price:</td><td>{TOTAL_PRODUCT_PRICE}₫</td></tr><tr class='total-row'><td colspan='4'>Shipping Fee:</td><td>{SHIPPING_FEE}₫</td></tr></tbody></table><div class='divider'></div><p class='total-amount'>Total Amount: {TOTAL_AMOUNT}₫</p><div class='ghtk-logo-container'><img src='https://cdn.prod.website-files.com/5fb85f26f126ce08d792d2d9/65fddaf530962fa5db994b27_Giaokime_main-thum.jpg' alt='Giao Hàng Tiết Kiệm'></div></div></body></html>\r\n";
        ...
        public async Task SendEmailAsync(string to, string subject, string body)
        {
            ...
            email.Cc.AddRange(new[]
            {
                ...
                MailboxAddress.Parse("vietltse173165@fpt.edu.vn")
            });
