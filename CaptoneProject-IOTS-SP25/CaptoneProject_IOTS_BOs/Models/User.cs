...
public partial class User
{
    ...
    public virtual ICollection<IotsDevice>? MaterialCreatedByNavigations { get; set; } = new List<IotsDevice>();

    public virtual ICollection<IotsDevice>? MaterialUpdatedByNavigations { get; set; } = new List<IotsDevice>();
